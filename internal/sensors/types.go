...
var AllSensors = []SensorDefinition{
	{1, "PowerStatus", "电源状态", "Power Status", "sensor", "", ""},
	{2, "Speed", "车速", "Speed", "sensor", "speed", "km/h"},
	{3, "Mileage", "里程", "Mileage", "sensor", "distance", "km"},
	{4, "GearPosition", "档位", "Gear Position", "sensor", "", ""},
	{5, "EngineRPM", "发动机转速", "Engine RPM", "sensor", "", "rpm"},
	{6, "BrakeDepth", "刹车深度", "Brake Depth", "sensor", "", "%"},
	{7, "AcceleratorDepth", "加速踏板深度", "Accelerator Depth", "sensor", "", "%"},
	{8, "FrontMotorRPM", "前电机转速", "Front Motor RPM", "sensor", "", "rpm"},
	{9, "RearMotorRPM", "后电机转速", "Rear Motor RPM", "sensor", "", "rpm"},
	{10, "EnginePower", "发动机功率", "Engine Power", "sensor", "power", "kW"},
	{11, "FrontMotorTorque", "前电机扭矩", "Front Motor Torque", "sensor", "", "Nm"},
	{12, "LastWiperTime", "充电枪插枪状态", "Last Wiper Time", "sensor", "timestamp", ""},
	{13, "Weather", "百公里电耗", "Weather", "sensor", "", ""},
	{14, "CabinTemperature", "最高电池温度", "Cabin Temperature", "sensor", "temperature", "°C"},
	{15, "AvgBatteryTemp", "平均电池温度", "Average Battery Temperature", "sensor", "temperature", "°C"},
	{16, "TemperatureUnit", "最低电池温度", "Temperature Unit", "sensor", "", ""},
	{17, "MaxBatteryVoltage", "最高电池电压", "Max Battery Voltage", "sensor", "voltage", "V"},
	{18, "SteeringRotationSpeed", "最低电池电压", "Steering Rotation Speed", "sensor", "", "deg/s"},
	{19, "LaneCurvature", "上次雨刮时间", "Lane Curvature", "sensor", "", ""},
	{20, "RightLineDistance", "天气", "Right Lane Distance", "sensor", "distance", "m"},
	{21, "LeftLineDistance", "主驾驶安全带状态", "Left Lane Distance", "sensor", "distance", "m"},
	{22, "CruiseSwitch", "远程锁车状态", "Cruise Switch", "binary_sensor", "power", ""},
	{23, "FootwellLights", "脚部照明灯", "Footwell Lights", "binary_sensor", "light", ""},
	{24, "FrontWiperSpeed", "前雨刮速度", "Front Wiper Speed", "sensor", "", ""},
	{25, "AutoParking", "车内温度", "Auto Parking", "binary_sensor", "", ""},
	{26, "OutsideTemperature", "车外温度", "Outside Temperature", "sensor", "temperature", "°C"},
	{27, "AIVehicleConfidence", "主驾驶空调温度", "AI Vehicle Confidence", "sensor", "", "%"},
	{28, "AIPersonConfidence", "温度单位", "AI Person Confidence", "sensor", "", "%"},
	{29, "BatteryCapacity", "电池容量", "Battery Capacity", "sensor", "energy_storage", "kWh"},
	{30, "Row2LeftSeatbelt", "方向盘转角", "Row 2 Left Seatbelt", "binary_sensor", "safety", ""},
	{31, "Row2RightSeatbelt", "方向盘转速", "Row 2 Right Seatbelt", "binary_sensor", "safety", ""},
	{32, "Row2CenterSeatbelt", "总电耗", "Row 2 Center Seatbelt", "binary_sensor", "safety", ""},
	{33, "BatteryPercentage", "电量百分比", "Battery Percentage", "sensor", "battery", "%"},
	{34, "Year", "油量百分比", "Year", "sensor", "timestamp", ""},
	{35, "Month", "总燃油消耗", "Month", "sensor", "timestamp", ""},
	{36, "Day", "车道线曲率", "Day", "sensor", "timestamp", ""},
	{37, "Hour", "右侧线距离", "Hour", "sensor", "timestamp", ""},
	{38, "Minute", "左侧线距离", "Minute", "sensor", "timestamp", ""},
	{39, "VehicleOperatingMode", "蓄电池电压", "Vehicle Operating Mode", "sensor", "", ""},
	{40, "VehicleRunningMode", "雷达左前", "Vehicle Running Mode", "sensor", "", ""},
	{41, "LeftRearChildLock", "雷达右前", "Left Rear Child Lock", "binary_sensor", "lock", ""},
	{42, "RightRearChildLock", "雷达左后", "Right Rear Child Lock", "binary_sensor", "lock", ""},
	{43, "RearLeftProximityAlert", "雷达右后", "Rear Left Proximity Alert", "binary_sensor", "safety", ""},
	{44, "RearRightProximityAlert", "雷达左", "Rear Right Proximity Alert", "binary_sensor", "safety", ""},
	{45, "RadarFrontLeft", "雷达前左中", "Radar Front Left", "sensor", "distance", "m"},
	{46, "RadarFrontRight", "雷达前右中", "Radar Front Right", "sensor", "distance", "m"},
	{47, "RadarRearLeft", "雷达中后", "Radar Rear Left", "sensor", "distance", "m"},
	{48, "RadarRearRight", "前雨刮速度", "Radar Rear Right", "sensor", "distance", "m"},
	{49, "RadarLeft", "雨刮档位", "Radar Left", "sensor", "distance", "m"},
	{50, "RadarFrontMidLeft", "巡航开关", "Radar Front Mid Left", "sensor", "distance", "m"},
	{51, "RadarFrontMidRight", "前车距离", "Radar Front Mid Right", "sensor", "distance", "m"},
	{52, "ChargingStatus", "充电状态", "Charging Status", "sensor", "power", ""},
	{53, "LeftFrontTirePressure", "左前轮气压", "Left Front Tire Pressure", "sensor", "pressure", "bar"},
	{54, "RightFrontTirePressure", "右前轮气压", "Right Front Tire Pressure", "sensor", "pressure", "bar"},
	{55, "LeftRearTirePressure", "左后轮气压", "Left Rear Tire Pressure", "sensor", "pressure", "bar"},
	{56, "RightRearTirePressure", "右后轮气压", "Right Rear Tire Pressure", "sensor", "pressure", "bar"},
	{57, "ParkingLights", "左转向灯", "Parking Lights", "binary_sensor", "light", ""},
	{58, "LowBeamLights", "右转向灯", "Low Beam Lights", "binary_sensor", "light", ""},
	{59, "HighBeamLights", "主驾车门锁", "High Beam Lights", "binary_sensor", "light", ""},
	{60, "FrontFogLights", "前雾灯", "Front Fog Lights", "binary_sensor", "light", ""},
	{61, "RearFogLights", "主驾车窗打开百分比", "Rear Fog Lights", "binary_sensor", "light", ""},
	{62, "DaytimeRunningLights", "副驾车窗打开百分比", "Daytime Running Lights", "binary_sensor", "light", ""},
	{63, "LeftTurnSignal", "左后车窗打开百分比", "Left Turn Signal", "binary_sensor", "light", ""},
	{64, "RightTurnSignal", "右后车窗打开百分比", "Right Turn Signal", "binary_sensor", "light", ""},
	{65, "HazardLights", "天窗打开百分比", "Hazard Lights", "binary_sensor", "light", ""},
	{66, "DriverDoor", "遮阳帘打开百分比", "Driver Door", "binary_sensor", "door", ""},
	{67, "PassengerDoor", "整车工作模式", "Passenger Door", "binary_sensor", "door", ""},
	{68, "LeftRearDoor", "整车运行模式", "Left Rear Door", "binary_sensor", "door", ""},
	{69, "RightRearDoor", "月", "Right Rear Door", "binary_sensor", "door", ""},
	{70, "TrunkDoor", "日", "Trunk Door", "binary_sensor", "door", ""},
	{71, "Hood", "时", "Hood", "binary_sensor", "door", ""},
	{72, "DriverDoorLock", "分", "Driver Door Lock", "binary_sensor", "lock", ""},
	{73, "PassengerDoorLock", "副驾安全带警告", "Passenger Door Lock", "binary_sensor", "lock", ""},
	{74, "LeftRearDoorLock", "二排左安全带", "Left Rear Door Lock", "binary_sensor", "lock", ""},
	{75, "RightRearDoorLock", "二排右安全带", "Right Rear Door Lock", "binary_sensor", "lock", ""},
	{76, "TrunkLock", "二排中安全带", "Trunk Lock", "binary_sensor", "lock", ""},
	{77, "SunroofOpenPercent", "空调状态", "Sunroof Open Percent", "sensor", "", "%"},
	{78, "DriverWindowOpenPercent", "风量档位", "Driver Window Open Percent", "sensor", "", "%"},
	{79, "PassengerWindowOpenPercent", "空调循环方式", "Passenger Window Open Percent", "sensor", "", "%"},
	{80, "LeftRearWindowOpenPercent", "空调出风模式", "Left Rear Window Open Percent", "sensor", "", "%"},
	{81, "RightRearWindowOpenPercent", "主驾车门", "Right Rear Window Open Percent", "sensor", "", "%"},
	{82, "DriverSeatbelt", "副驾车门", "Driver Seatbelt", "binary_sensor", "safety", ""},
	{83, "PassengerSeatbeltWarn", "左后车门", "Passenger Seatbelt Warn", "binary_sensor", "safety", ""},
	{84, "PowerStatus", "右后车门", "Power Status", "sensor", "", ""}, // Duplicate ID 1
	{85, "ACStatus", "引擎盖", "AC Status", "binary_sensor", "power", ""},
	{86, "DriverACTemperature", "后备箱门", "Driver AC Temperature", "sensor", "temperature", "°C"},
	{87, "ACCCruiseStatus", "油箱盖", "ACC Cruise Status", "binary_sensor", "", ""},
	{88, "WiperGear", "自动驻车", "Wiper Gear", "sensor", "", ""},
	{89, "TotalPowerConsumption", "ACC巡航状态", "Total Power Consumption", "sensor", "energy", "kWh"},
	{90, "WirelessADBSwitch", "左后接近告警", "Wireless ADB Switch", "binary_sensor", "power", ""},
	{91, "SteeringAngle", "右后接近告警", "Steering Angle", "sensor", "", "°"},
	{92, "AcceleratorDepth", "车道保持状态", "Accelerator Depth", "sensor", "", "%"},
	{93, "BrakeDepth", "左后车门锁", "Brake Depth", "sensor", "", "%"},
	{94, "MinBatteryVoltage", "副驾车门锁", "Min Battery Voltage", "sensor", "voltage", "V"},
	{95, "ChargeGunState", "右后车门锁", "Charge Gun State", "sensor", "", ""},
	{96, "MinBatteryTemp", "后备箱门锁", "Min Battery Temp", "sensor", "temperature", "°C"},
	{97, "MaxBatteryTemp", "左后儿童锁", "Max Battery Temp", "sensor", "temperature", "°C"},
	{98, "FanSpeedLevel", "右后儿童锁", "Fan Speed Level", "sensor", "", ""},
	{99, "ACBlowingMode", "小灯", "AC Blowing Mode", "sensor", "", ""},
	{100, "ACCirculationMode", "近光灯", "AC Circulation Mode", "sensor", "", ""},
	{101, "RemoteLockStatus", "远光灯", "Remote Lock Status", "binary_sensor", "lock", ""},
	{102, "SunshadeOpenPercent", "遮阳帘开启百分比", "Sunshade Open Percent", "sensor", "", "%"},
	{103, "LaneKeepAssistStatus", "车道保持辅助状态", "Lane Keep Assist Status", "binary_sensor", "safety", ""},
	{104, "DistanceToCarAhead", "前雾灯", "Distance To Car Ahead", "sensor", "distance", "m"},
	{105, "BatteryVoltage12V", "后雾灯", "12V Battery Voltage", "sensor", "voltage", "V"},
	{106, "PowerConsumption100km", "脚照灯", "Power Consumption 100km", "sensor", "energy", "kWh/100km"},
	{107, "SurroundViewStatus", "日行灯", "Surround View Status", "binary_sensor", "", ""},
	{108, "UIConfigVersion", "发动机水温", "UI Config Version", "sensor", "", ""},
	{109, "SentryModeStatus", "双闪", "Sentry Mode Status", "binary_sensor", "", ""},
	{110, "PowerOffRecordingConfig", "熄火录制配置", "Power Off Recording Config", "binary_sensor", "", ""},
	{111, "PowerOffSentryAlarm", "熄火哨兵警报", "Power Off Sentry Alarm", "binary_sensor", "", ""},
	{112, "WiFiStatus", "WiFi状态", "WiFi Status", "binary_sensor", "connectivity", ""},
	{113, "BluetoothStatus", "蓝牙状态", "Bluetooth Status", "binary_sensor", "connectivity", ""},
	{114, "BluetoothSignalStrength", "蓝牙信号强度", "Bluetooth Signal Strength", "sensor", "signal_strength", "dBm"},
	{115, "LastSentryTriggerTime", "上次哨兵触发时间", "Last Sentry Trigger Time", "sensor", "timestamp", ""},
	{116, "LastSentryTriggerImage", "上次哨兵触发图像", "Last Sentry Trigger Image", "sensor", "", ""},
	{117, "LastVideoStartTime", "上次录像开始时间", "Last Video Start Time", "sensor", "timestamp", ""},
	{118, "LastVideoEndTime", "上次录像结束时间", "Last Video End Time", "sensor", "timestamp", ""},
	{119, "LastVideoPath", "上次录像路径", "Last Video Path", "sensor", "", ""},
	{120, "RadarRearCenter", "后中雷达", "Radar Rear Center", "sensor", "distance", "m"},
}
